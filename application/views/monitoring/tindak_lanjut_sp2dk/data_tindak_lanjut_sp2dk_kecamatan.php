...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col">
			<?php echo anchor(site_url('cetak/monitoring_tindak_lanjut_sp2dk'), 'Export', 'class="btn btn-success" target="_blank"'); ?>
		</div>
	</div>
				...
				<table class="table table-striped table-sm" id="example2" width="100%" cellspacing="0">
					...
					<tbody><?php
							...
							<tr>
								...
								<td align="center">
									<?php echo anchor(site_url('data/monitoring_tindak_lanjut_sp2dk/' . $row->id), '<button type="button" id="detail" class="btn btn-sm btn-primary detail" data-toggle="modal" data-target="#detailModal" data-tooltip="tooltip" data-placement="bottom" title="Detail"><i class="fa fa-eye"></i></button>', array('class' => '')); ?>
								</td>
