...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col">
			<?php echo anchor(site_url('cetak/monitoring_tindak_lanjut_sp2dk/' . $monitoring['id']), 'Export', 'class="btn btn-success" target="_blank"'); ?>
		</div>
		<div class="col">
			<h3><?= ' Kecamatan ' . $monitoring['nama'] ?></h3>
		</div>
		<div class="col d-flex justify-content-end">
			<a href="<?php echo base_url() ?>data/monitoring_tindak_lanjut_sp2dk_kecamatan">
