		...
		<div class="table-responsive">
			...
			<form action="<?php echo $action; ?>" method="post">
				<div class="form-group">
					<label for="varchar"> Rekam No. SP2DK <?php echo form_error('sp2dk_nomor') ?></label>
					<input type="text" class="form-control" name="sp2dk_nomor" id="sp2dk_nomor" value="<?= $sp2dk_nomor; ?>" />
				</div>
