<div class="card shadow mb-12">
	<div class="card-body">
		<div class="table-responsive">
			...
			<?php if (!empty($alasan) && $data['verifikasi'] != 1) : ?>
			...
			<div class="text-right">
				<form action="<?php echo base_url('data/verifikasi_material_verifikasi'); ?>" method="post" style="display: inline;">
				...
				<a href=" <?php echo site_url('data/verifikasi_material') ?>" class="btn btn-primary">Kembali</a>
			</div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" action="<?php echo base_url('data/verifikasi_material_batal'); ?>" method="post">
					<input type="hidden" name="id" value="<?= $data['id']; ?>" />
